...
class StageConfig:
    ...
    num_goal_obs = 0  # command injection keeps this at 0 for both standard and track
...
class TrackConfig(StageConfig):
    ...
    obs layout: proprio(45) + height_scan(256) = 301
    critic obs: critic_proprio(60) + height_scan(256) = 316
    """
